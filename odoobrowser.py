...
def view_model(model_name=None):
    ...
    return render_template('data_list.html',
                           objects=results, model_name=model_name)
...
def list_models():
    ...
    return render_template('model_list.html',
                           objects=results, length=len(results))
...
def list_fields(model_id):
    ...
    return render_template('field_list.html',
                           objects=results, length=len(results))
...
def view_data(model_name):
    ...
    app.logger.debug(results)
    return render_template('all_data_list.html',
                           objects=results, length=len(results))
...
def view_plantuml():
    ...
    return render_template(
        'plantuml.txt',
        objects=results,
        relations=relations), 200, {'Content-Type': 'text/plain'}
